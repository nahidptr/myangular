...
describe('injector', function () {
  ...
  it('invokes an non-annotated function with dependency injection', function () {
  ...
  it('uses the prototype of the constructor function when instantiating', function () {
  ...
  it('mine can inject instance to a provider get function', function () {
    ...
    module.provider('b', function BProvider() {
      this.$get = function (a) { return a + 41; };
    });
  ...
  it('does not allow injecting the $provide service to $get', function () {
    ...
    var injector = createInjector(['myModule']);
    expect(function() { injector.get('a'); }).toThrow();
  ...
  it('runs run blocks when the instance injector', function () {
    var module = angular.module('myModule', []);
  ...
  it('configures all modules before running any run blocks', function () {
    ...
    var module2 = angular.module('myOtherModule', []);
    module2.provider('b', {$get: _.constant(1)});
  ...
  it('injects a factory function with instances', function () {
    ...
    module.factory('a', function () { return 41; });
  ...
  it('force a factory to return a value', function () {
  ...
  it('only instantiate services once', function () {
    var module = angular.module('myModule', []);
  ...
  it('uses dependency injection with decorator', function () {
...
describe('annotate', function () {
  ...
  it('returns an empty array from non annotation 0 arg function', function () {
