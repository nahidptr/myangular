...
describe('$compile', function () {
  ...
  it('allows create directives', function () {
  ...
  it('does not allow a directives called hasOwnProperty', function () {

    var myModule = window.angular.module('myModule', []);
    myModule.directive('hasOwnProperty', _.noop);

    expect(function () {
      createInjector(['ng', 'myModule']).toThrow();
    });

  });

  it('allows creating many directives with object notation', function () {
  ...
  function makeInjectorWithDirectives() {
    ...
    //! its have $compileProvider provider in its name, since in the invokeQueue its called with providerInjector
    return createInjector(['ng', function ($compileProvider) {
      $compileProvider.directive.apply($compileProvider, args);
    }]);
  }

  it('compiles element directives from single element', function () {
  ...
  // Prefixes with Element Directive
  ...
  // Applying Directive to Attribute
  ...
  it('compiles several class directives in an element',function () {
    ...
    injector.invoke(function ($compile) {
      var el = $('<my-directive class="my-directive my-second-directive"></my-directive>');
      $compile(el);
      expect(el.data('hasCompiled')).toBe(true);
      expect(el.data('secondCompiled')).toBe(true);
    });
  ...
  it('applies in name order when priorities are the same', function () {
    ...
    injector.invoke(function ($compile) {
      ...
      $compile(el);
      expect(compilations).toEqual(['lower', 'higher']);
    });
  ...
  // Chapter 16 Directives Attributes
  ...
  describe('attributes', function () {
   ...
   function registerAndCompile(dirName, domString, callback) {
    ...
    it('sets props for boolean attributes even when not flushing', function () {
    ...
    it('denormalizes attributes by snake-casing', function () {
    ...
    describe('Observing', function () {
      ...
      it('calls observer immediately when attribute is $set', function () {
        ...
        registerAndCompile(
          'myDirective',
          '<input my-directive some-attribute="42">',
          function (element, attrs) {
      ...
      it('lets observers be deregistration', function () {
    ...
    it('adds an attribute from class directive', function () {
    ...
    it('adds an attribute with a value from comment directives', function () {
  ...
  describe('linking', function () {
    ...
    //Linking Child Nodes
    it('link directive on child elements first', function () {
    ...
    it('link children when parent has no directives', function () {
    ...
    it('supports links function objects', function () {
    ...
    it('reverses priority for postlinking functions', function () {
    ...
    it('invokes multi element directive link functions with whole group', function () {
      ...
      injector.invoke(function ($compile, $rootScope) {
        var el = $('<div my-directive-start></div>' +
                     '<p></p>' +
    ...
    describe('scope', function () {
      ...
      it('creates an isolated scope when requested', function () {
        var givenScope;
        var injector = makeInjectorWithDirectives('myDirective', function() {
          return {
            scope: {},
      ...
      it('does not share isolated scope with other directives', function () {
        var givenScope;
        var injector = makeInjectorWithDirectives( {
          myDirective: function() {
            return {
      ...
      it('does not use isolated scope on child elements', function () {
        var givenScope;
        var injector = makeInjectorWithDirectives( {
          myDirective: function() {
            return {
      ...
      it('allows aliasing observed attribute', function () {
        ...
        injector.invoke(function ($compile, $rootScope) {
          ...
          expect(givenScope.anScopeAttr).toEqual('42');
      ...
      it('allows binding expression to isolate scope', function () {
        ...
        injector.invoke(function ($compile, $rootScope) {
          ...
          expect(givenScope.anAttr).toEqual(42);  // not '42' but 42

        });
      });

      it('allows aliasing expression attribute on to isolate scope', function () {
        ...
        injector.invoke(function ($compile, $rootScope) {
          ...
          expect(givenScope.myAttr).toEqual(42);  // not '42' but 42
      ...
      it('throws when isolate scope expression return new array', function () {
      ...
      it('can watch isolated scope expression as collection', function () {
      ...
      it('does not watch optional missing isolate scope expression', function () {
  ...
  describe('controllers', function () {
    ...
    // Locals in Directives Controller
