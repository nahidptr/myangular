...
describe("$q", function () {
  ...
  it('invokes callback once', function () {
  ...
  it('fulfils on on chained handler', function () {
  ...
  it('treats catch return value as resolution', function () {
    ...
    d.promise.catch(_.constant(42)).then(fulfilledSpy);
  ...
  it('allows chaining handlers on finally, with original rejections', function () {
  ...
  it('recovers from progress back exceptions', function () {
  ...
  describe('ES6 style', function () {
    ...
    it('expects a function as argument', function () {
