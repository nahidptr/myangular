...
function qFactory(callLater) {
    ...
    pending.forEach((handlers) => {
      ...
      try {
        if (_.isFunction(fn)) {
          ...
          //! if either handler is missing and from that successive handler are called
  ...
  Deferred.prototype.resolve = function (value) {
    ...
    if (value && _.isFunction(value.then)) {
      value.then(_.bind(this.resolve, this),
      ...
      callLater(function () {
        pending.forEach(function (handlers) {
          ...
          try {
            ...
            console.log('deferred notify throws ' + e);
          }
        });
      });
    }
