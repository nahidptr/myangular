...
function markConstantAndWatchExpressions(ast, $filter) {
  ...
  switch (ast.type) {
    ...
    case AST.ArrayExpression:
      allConstants = true;
      argsToWatch = [];
      ast.elements.forEach(el => { markConstantAndWatchExpressions(el, $filter);
    ...
    case AST.ObjectExpression:
      allConstants = true;
      argsToWatch = [];
      ast.properties.forEach(property => { markConstantAndWatchExpressions(property.value, $filter);
